...
# Function to tokenize using the mGPT tokenizer
def tokenize(texts, tokenizer):
    """
    Tokenizes a list of texts using the mGPT tokenizer.
...
for lang in languages:
    ...
    try:
        ...
        # Tokenize using the mGPT tokenizer
...
df_compression.to_csv("mgpt_max_compression_ratio.csv", index=False)
print("Results saved to mgpt_max_compression_ratio.csv")
...
df_parity.to_csv("mgpt_min_tokenization_parity.csv", index=False)
print("Results saved to mgpt_min_tokenization_parity.csv")
print(df_parity)
