...
# Load the tokenizer for the M-BERT-Distil-40 model
...
def tokenize(texts, tokenizer):
    """
    Tokenizes a list of texts using the M-BERT-Distil-40 tokenizer.
...
with open("computations_mbert_distil.json", "w") as json_file:
    json.dump(results_json, json_file, indent=4)
print("\nResults saved to computations_mbert_distil.json")
