...
def tokenize(texts, tokenizer):
    """
    Tokenizes a list of texts using the mT5-small tokenizer.
...
with open("computations_mt5_small.json", "w") as json_file:
    json.dump(results_json, json_file, indent=4)
print("\nResults saved to computations_mt5_small.json")
