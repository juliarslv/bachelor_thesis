...
df_compression.to_csv("xglm_max_compression_ratio.csv", index=False)
print("Results saved to xglm_max_compression_ratio.csv")
...
df_parity.to_csv("xglm_min_tokenization_parity.csv", index=False)
print("Results saved to xglm_min_tokenization_parity.csv")
print(df_parity)
