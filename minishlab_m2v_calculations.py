...
# Load the tokenizer
model_name = "minishlab/M2V_multilingual_output"  # Manually set the new model name
...
compression_file = "max_compression_ratio_minishlab_M2V.csv"
...
parity_file = "min_tokenization_parity_minishlab_M2V.csv"
