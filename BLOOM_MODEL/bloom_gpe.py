'''
To BLOOM Tokenization Type -> https://arxiv.org/pdf/2211.05100
...
df_compression.to_csv("gpe_max_compression_ratio.csv", index=False)
print("Results saved to gpe_max_compression_ratio.csv")
...
df_parity.to_csv("gpe_min_tokenization_parity.csv", index=False)
print("Results saved to gpe_min_tokenization_parity.csv")
print(df_parity)
